...
RUN chown -R www-data:www-data /var/www/skills-api/var/cache /var/www/skills-api/var/logs /var/www/skills-api/var/sessions

RUN apt-get update \
    && apt-get install -y libicu-dev git zip libssl-dev mongodb \
